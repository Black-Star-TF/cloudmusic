<template>
	<div class="radio-program-item-container" :class="{'active': isActive}" @dblclick="play">
		...
		<!-- 收听数量 -->
		<span class="radio-program-item-listener-count">{{listenerCount}}</span>
		<!-- 获赞量 -->
		<span class="radio-program-item-liked-count">{{radioProgramItem.likedCount}}</span>
		<!-- 创建时间 -->
...
<style>
	...
	.radio-program-item-container .radio-program-item-serial-num{
		width: 2%;
		margin-left: 2.5%;
		margin-right: 1.5%;
	}
	...
	.radio-program-item-container .radio-program-item-listener-count{
		
	}
	
	.radio-program-item-container .radio-program-item-liked-count{
		
	}
	
	.radio-program-item-container .radio-program-item-create-time{
		width: 8%;
	}
		
	.radio-program-item-container .radio-program-item-duration{
